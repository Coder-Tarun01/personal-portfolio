  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="flex flex-col lg:flex-row gap-12 items-start">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex-1 w-full min-h-[500px] space-y-8"
      >
        {/* Get In Touch Card */}
        <div className="bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-sm p-8 rounded-xl border border-purple-500/20">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <a href="tel:+919848151735" className="text-white hover:text-purple-300 transition-colors">
                  +91 9848151735
                </a>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <a href="mailto:tarunsaikumarinti3@gmail.com" className="text-white hover:text-purple-300 transition-colors">
            ...
            <button
              ...
              className="w-full mt-4 px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl focus:outline-none"
            >
      ...
      >
        <motion.form
          ...
          className="w-full bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-sm p-8 rounded-xl border border-purple-500/20 flex flex-col justify-between"
          style={{ minHeight: '100%' }}
        >
          <div>
            <h3 className="text-2xl font-bold mb-6 text-white">Send Me a Message</h3>
            <p className="text-gray-400 mb-6">I’d love to hear from you. Fill out the form below.</p>
          </div>
          ...
          <div className="space-y-6 flex-1">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                required
                className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-white placeholder-gray-400 resize-none h-32"
          ...
          <button
            type="submit"
            className="w-full mt-6 px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-105"
          >
            Send Message
          </button>
        </motion.form>
      ...
      <motion.button
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        className="fixed bottom-6 right-6 p-3 bg-gradient-to-r from-purple-600 to-cyan-600 text-white rounded-full shadow-lg hover:shadow-xl hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-110 focus:outline-none z-40"
